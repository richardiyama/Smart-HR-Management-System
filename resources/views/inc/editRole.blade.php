...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
      ...
      <div class="x_content">
          <br />
          <form id="roleform" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{ route('UserRole.update', $role->id )}}">
                  {{ method_field('PATCH') }}
                  {{ csrf_field() }}
                ...
                <div class="modal-body">
                  <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" id="name" name="name" value="{{ $role->role_name }}" required="" class="form-control col-md-7 col-xs-12">
