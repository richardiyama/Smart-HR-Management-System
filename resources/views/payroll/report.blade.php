...
@section('content')
    <!-- page content -->
        ...
        {{-- <div class="row tile_count">
          ...
          <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-building-o"></i> Total Number of New Employees this year</span>
        ...
        <div class="row tile_count">
          <div class="col-md-12 col-sm-3 col-xs-3" style="text-align:right">
              <button type="button" class="btn btn-success">Add a New Employee</button>
              <button type="button" class="btn btn-success">Bulk Transfer</button>
          </div>
        </div> --}}
        <!-- /top tiles -->

        <div class="row">
            {{-- <div class="col-md-12">Sele From:</div> --}}
                <div class="col-m-12">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                          <div class="x_title">
                            <h2>Payroll <small>Report</small></h2>
                                  ...
                                  <div class="form-group">  
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter employees name">
                                        </div>
                                      </div>
                                </form>
                            </div>
